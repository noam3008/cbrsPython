...
TEST_HAD_BEEN_FINISHED_FLASK =              " all the steps of the test had been finished see final results at the console and no other test had been selected"
...
HEARTBEAT_FROM_ENGINE_TO_ENODEB_MESSAGE =   "return heart beat part of json from engine to the eNodeB"
ADDITIONAL_COMMENTS_MESSAGE =               "the additional comments for the current test are : "
ANSWERS_NODE =                              "answers"
QUESTION_NODE =                             "question"
HEART_BEAT_TIMEOUT_MESSAGE =                "heartbeat had reached to the limit of heartbeat set from the config file"
